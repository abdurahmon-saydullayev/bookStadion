...
func Load() Config {
	...
	// type assertation
	config.App = cast.ToString(getOrReturnDefaultValue("PROJECT_NAME", "football"))
	...
	config.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "station"))
